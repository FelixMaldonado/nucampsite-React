    ...
    const HomePage = () => {
      return (
          <Home
              ...
              promotions={this.props.promotions.promotions.filter(promotion => promotion.featured)[0]}
              promotionLoading = {this.props.promotions.isLoading}
              promotionErrMess={this.props.promotions.errMess}
              partner={this.props.partners.partners.filter(partner => partner.featured)[0]}
              partnerisLoading={this.props.partners.isLoading}
...
const reduxComponent = connect(mapStateToProps, mapDispatchToProps)(Main);

const routerComponent = withRouter(reduxComponent);
